...
もちろん、上で名前を挙げたNicola Rennieさん、Danielle Navarroさん、Thomas Lin Pedersenさんあたりは「訓練された」ジェネラティブアーティストなので、ノイズなどを上手に使いながら、ザラザラしたサンドアートみたいなテクスチャを実現していたりします。しかし、データ駆動型のジェネラティブアートでは、そうした質感を実現するために、その質感と結びつくようなデータから用意したりする必要があるわけで、そのあたりを攻略するにはたぶん相当な訓練が必要です。
...
この記事では、R言語でのアート制作に挑戦するにあたって開発したパッケージについて、実際につくった作品の例と一緒に紹介しました。

今回紹介したパッケージ群はまだ発展途上のものであり、Rを使ったアート制作にはきっとさらなる可能性があると思っています。来年ももっといろいろな表現にチャレンジしていくつもりなので、興味を持ってもらえたら、ぜひ一緒に遊んでみてください！　Rで絵を描く仲間が少しでも増えたら、とても嬉しいです。
